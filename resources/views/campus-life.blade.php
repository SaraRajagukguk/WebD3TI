@include('layouts.main')
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Campus Life</h2>
                    ...
                    <div class="col-lg-6">
                        <div class="content-info wow fadeInUp" data-wow-delay=".25s">
                            <div class="site-heading mb-3">
                                <span class="site-title-tagline"><i class="far fa-book-open-reader"></i> Campus Life</span>
                                <h2 class="site-title">
                                    Details About <span>Eduka Campus</span> Experience.
                                </h2>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="details-item">
                                <h3 class="mb-3">Our Campus Life</h3>
                                <p>
