@include('layouts.main')
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Portfolio Single</h2>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4">
                            <div class="portfolio-sidebar">
                                <div class="widget portfolio-sidebar-content">
                                    ...
                                    <ul>
                                        <li>
                                            Category <span>Student Health Care</span>
                                        </li>
                                        <li>
                                            Date <span>21 June, 2024</span>
                                        </li>
                                        <li>
                                            Student Name <span>Roger M Collins</span>
                                        </li>
                                        <li>
                                            Total Cost <span>$1250.00</span>
                                        </li>
                                        <li>
                                            Health Manager <span>Doseph Brehmer</span>
                                        </li>
                                        <li>
                                ...
                                <div class="widget new-portfolio">
                                    <h4>Our 20% Offer Running - Join Today For Your Course</h4>
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="portfolio-details">
                                ...
                                <div class="portfolio-details">
                                    <h3 class="mb-20">Student Health Care</h3>
                                    <p class="mb-20">
                                    ...
                                    <div class="my-4">
                                        <div class="mb-3">
                                            <h3 class="mb-3">Health Care Tips</h3>
                                    ...
                                    <div class="my-4">
                                        <h3 class="mb-3">Overview And Challenge</h3>
