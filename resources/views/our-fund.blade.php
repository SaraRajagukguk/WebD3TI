                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4">
                            <div class="fund-sidebar">
                                <div class="fund-btn">
                                    <a href="#" class="theme-btn">Become A Donor<i class="fas fa-arrow-right-long"></i>
                                    </a>
                                </div>
                                <div class="widget category">
                                    <h4 class="widget-title">Donation Category</h4>
                                    <div class="category-list">
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Student Scholarships</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Support Sport Team</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Schools & Colleges</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Student Life</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Library & Cultural</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Emergency Fund</a>
                                    </div>
                                </div>
                                <!-- social share -->
