@include('layouts.main')
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Research Single</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index.html">Home</a></li>
                    <li class="active">Research Single</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
                            ...
                            <div class="research-sidebar">
                                <div class="widget category">
                                    ...
                                    <div class="category-list">
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Science And Technology</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Business And Entrepreneurship</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Humanities And Social Sciences</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Allied Health Sciences</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Robort Space Research</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Medical Machines Research</a>
                                    </div>
                                </div>
                                <div class="widget research-download">
                                    <h4 class="widget-title">Download</h4>
                                    <a href="#"><i class="far fa-file-pdf"></i> Download Research</a>
