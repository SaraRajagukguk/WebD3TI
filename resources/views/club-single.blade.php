@include('layouts.main')
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Club Single</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index.html">Home</a></li>
                    <li class="active">Club Single</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
        ...
        <!-- club single -->
        <div class="club-single-area py-120">
            <div class="container">
                <div class="club-single-wrapper">
                    <div class="row">
                        <div class="col-xl-8 col-lg-8">
                            <div class="club-details">
                                <div class="club-details-img mb-30">
                                    <img src="assets/img/club/single.jpg" alt="thumb">
                                </div>
                                <div class="club-details">
                                    <h3 class="mb-20">Blood Donors Club</h3>
                                    <p class="mb-20">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-20">
                                            <img src="assets/img/club/06.jpg" alt="">
                                        </div>
                                        <div class="col-md-6 mb-20">
                                            <img src="assets/img/club/05.jpg" alt="">
                                        </div>
                                    </div>
                                    <p class="mb-20">
                                    ...
                                    <div class="my-4">
                                        <div class="mb-3">
                                            <h3 class="mb-3">Club Features</h3>
                                    ...
                                    <div class="my-4">
                                        <h3 class="mb-3">Club Benefits Of Our Students</h3>
                        ...
                        <div class="col-xl-4 col-lg-4">
                            <div class="club-sidebar">
                                <div class="widget category">
                                    <h4 class="widget-title">Our Clubs</h4>
                                    <div class="category-list">
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Computer And Programming Club</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Robotics Club</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Photographic Society</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Business And Edukation Club</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Voluntary Service Club</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Blood Donors Club</a>
                                    </div>
                                </div>
                                <div class="widget club-download">
                                    <h4 class="widget-title">Download</h4>
                                    <a href="#"><i class="far fa-file-pdf"></i> Download Member List</a>
